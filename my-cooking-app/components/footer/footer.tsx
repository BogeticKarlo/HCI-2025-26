    ...
    <footer className="bg-footer-bg text-footer-text py-10 px-6 mt-10">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-8">
          <div className="text-center sm:text-left">
            ...
            <p className="text-xs text-footer-text/70">
              Quick links for policy, terms, and social channels.
            </p>
          </div>
        ...
        <p className={helperText}>
          Tip: links are styled as buttons so you can instantly see what’s
          clickable.
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-10 text-center">
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <ul className="space-y-3 w-full">
              <li>
                <Link href="/privacy#information-we-collect" className={linkClass}>
                  <span aria-hidden>📄</span>
                  Information We Collect
                </Link>
              </li>
              <li>
                <Link href="/privacy#how-we-use" className={linkClass}>
                  <span aria-hidden>🧠</span>
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <ul className="space-y-3 w-full">
              <li>
                <Link href="/terms#acceptance" className={linkClass}>
                  <span aria-hidden>✅</span>
                  Acceptance of Terms
                </Link>
              </li>
              <li>
                <Link href="/terms#responsibilities" className={linkClass}>
                  <span aria-hidden>👤</span>
                  User Responsibilities
                </Link>
              </li>
              <li>
                <Link href="/terms#security" className={linkClass}>
                  <span aria-hidden>🔑</span>
                  Accounts & Security
                </Link>
              </li>
              <li>
                <Link href="/terms#payment" className={linkClass}>
                  <span aria-hidden>💳</span>
                  Payment
                </Link>
              </li>
